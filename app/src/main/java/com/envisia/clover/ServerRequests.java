...
/**
 * Created by JenishK on 26/12/15.
 */

public class ServerRequests {
    ProgressDialog progressDialog;
    public static final int CONNECTION_TIMEOUT = 1000 * 15;
    public static final String SERVER_ADDRESS = "http://clover123.net23.net/";
        ...
        protected User doInBackground(Void... params) {
            ...
            try {
                ...
                if (jObject.length() != 0){
                    ...
                    returnedUser = new User(firstname, lastname, age, user.username,
                            user.password);
                }
